...
import com.biglabs.solo.config.audit.AuditEventConverter;
import com.biglabs.solo.domain.PersistentAuditEvent;
...
import static com.biglabs.solo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
