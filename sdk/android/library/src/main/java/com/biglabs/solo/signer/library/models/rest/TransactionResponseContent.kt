...
internal class TransactionResponseContent {
    ...
    constructor(from: String, to: String, value: Long) {
        this.inputs = arrayOf(TransactionResponseContentInput(from))
        this.outputs = arrayOf(TransactionResponseContentOutput(to, value))
    }
